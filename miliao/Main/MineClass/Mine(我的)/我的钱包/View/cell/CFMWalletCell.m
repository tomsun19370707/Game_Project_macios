...
@interface CFMWalletCell ()
/** View */

@end

@implementation CFMWalletCell
...
{
    UIImage *image = IMAGE(@"mine_wallet_gold");
    CGFloat temp = image.size.height / image.size.width ;
    self.contentView.height = (SCREENWIDTH - 16 * 2) * temp ;
