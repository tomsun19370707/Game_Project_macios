//
//  EMO_APPCustomRoomMessageCell.m
//  miliao
//
...
@interface EMO_APPCustomRoomMessageCell ()
...
@implementation EMO_APPCustomRoomMessageCell
...
- (void)setDataModel:(RCMessageModel *)model {
    ...
    EMO_APPCustomRoomMessage *MessageModel = (EMO_APPCustomRoomMessage *)self.model.content;
    
    
    [self.headImgView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",MessageModel.roomImage]] placeholderImage:KGetImage(@"未加载头像")];
    self.IDLabel.text=[NSString stringWithFormat:@"%@",MessageModel.roomNotice];
    self.titleLabel1.text = [NSString stringWithFormat:@"%@  ",MessageModel.roomName];
