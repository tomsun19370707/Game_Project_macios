...
@interface CFMExRewardRuleAlert ()<WKUIDelegate, WKNavigationDelegate>
/** View */
...
@implementation CFMExRewardRuleAlert
...
-(void)setWebHtml:(NSString *)webHtml
{
    ...
    /** load*/
    [self.web loadHTMLString:strTemp baseURL:nil];
}
#pragma mark --
