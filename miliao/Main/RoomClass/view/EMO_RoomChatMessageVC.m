...
@interface EMO_RoomChatMessageVC ()<RCIMReceiveMessageDelegate,dgNavViewDelegate>
...
@implementation EMO_RoomChatMessageVC
...
- (void)viewDidLoad {
    ...
    self.conversationMessageCollectionView.frame=CGRectMake(0,kScreenHeight - 450, kWidth, 450);
...
-(void)InfoNotificationConfession:(NSNotification *)messageData{
    ...
    if ([dic[@"messageContent"] isKindOfClass:[RCImageMessage class]]) {
        ...
        [NetworkRequest POST:Request_CheckMessage parmeters:@{@"message":msg.content} success:^(id responObject) {
...
//            self.rightTwoButton.layer.cornerRadius=KAdaptedHeight(15);
//            self.rightTwoButton.layer.masksToBounds=YES;
//            self.rightTwoButton.layer.borderWidth=KAdaptedWidth(0.5);
//            self.rightTwoButton.layer.borderColor=RGBA(204, 204, 204, 1).CGColor;
            self.rightTwoButton.layer.contents=(id)KGetImage(@"followSelectImg").CGImage;
...
//            UIBarButtonItem *leftbtn1 = [[UIBarButtonItem alloc] initWithCustomView:leftButton];
//            self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:leftButton];
    //        self.navigationItem.leftBarButtonItems = [NSArray arrayWithObjects:leftbtn1, leftbtn2, nil];
