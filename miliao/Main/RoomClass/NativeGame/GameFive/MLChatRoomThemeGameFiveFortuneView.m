//
//  MLChatRoomThemeGameFiveFortuneView.m
//  miliao
//
...
@interface MLChatRoomThemeGameFiveFortuneView ()
...
@implementation MLChatRoomThemeGameFiveFortuneView
...
+ (void)showInView:(UIView *)parentView consume:(NSInteger)consume produce:(NSInteger)produce {
    ...
    MLChatRoomThemeGameFiveFortuneView *view = [[MLChatRoomThemeGameFiveFortuneView alloc] initWithFrame:targetView.bounds consume:consume produce:produce];
...
- (void)setupUI {
    ...
    // 2. Aspect-Ratio Locked Main Container (622:899 -> 300pt x 433pt)
    _bgImageView = [[UIImageView alloc] init];
    _bgImageView.image = [UIImage imageNamed:@"theme_game_five_fortune_bg"];
    _bgImageView.contentMode = UIViewContentModeScaleToFill;
    _bgImageView.userInteractionEnabled = YES;
    [self addSubview:_bgImageView];
    [_bgImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.center.mas_equalTo(self);
        make.size.mas_equalTo(CGSizeMake(KDialogAdaptedWidth(300), KDialogAdaptedWidth(433)));
    }];
    ...
    CGFloat itemW = KDialogAdaptedWidth(234.0f);
    CGFloat itemH = KDialogAdaptedWidth(78.0f);
    CGFloat marginX = KDialogAdaptedWidth(28.0f);

    // Item 1: 今日消耗
    _consumeBox = [[UIImageView alloc] init];
    _consumeBox.image = [UIImage imageNamed:@"theme_game_five_fortune_item_bg"];
    ...
    _consumeTitleLabel.textColor = mHexRGB(0xFFFFFF);
    ...
    _produceBox.image = [UIImage imageNamed:@"theme_game_five_fortune_item_bg"];
    ...
    [_produceBox mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(_consumeBox.mas_bottom).offset(KDialogAdaptedWidth(10));
        make.centerX.mas_equalTo(_bgImageView);
        make.size.mas_equalTo(CGSizeMake(itemW, itemH));
    }];
    ...
    _produceTitleLabel.textColor = mHexRGB(0xFFFFFF);
    ...
    _yieldBox.image = [UIImage imageNamed:@"theme_game_five_fortune_item_bg"];
    ...
    [_yieldBox mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(_produceBox.mas_bottom).offset(KDialogAdaptedWidth(10));
        make.centerX.mas_equalTo(_bgImageView);
        make.size.mas_equalTo(CGSizeMake(itemW, itemH));
    }];
    ...
    _yieldTitleLabel.textColor = mHexRGB(0xFFFFFF);
