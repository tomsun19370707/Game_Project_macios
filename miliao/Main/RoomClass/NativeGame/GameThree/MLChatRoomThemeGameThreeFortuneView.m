//
//  MLChatRoomThemeGameThreeFortuneView.m
//  miliao
//
...
@interface MLChatRoomThemeGameThreeFortuneView ()
...
@implementation MLChatRoomThemeGameThreeFortuneView
...
+ (void)showInView:(UIView *)parentView consume:(NSInteger)consume produce:(NSInteger)produce {
    ...
    MLChatRoomThemeGameThreeFortuneView *view = [[MLChatRoomThemeGameThreeFortuneView alloc] initWithFrame:targetView.bounds consume:consume produce:produce];
...
- (void)setupUI {
    ...
    // 2. Aspect-Ratio Locked Main Container (603:686 -> 300pt x 341pt)
    _bgImageView = [[UIImageView alloc] init];
    _bgImageView.image = [UIImage imageNamed:@"theme_game_three_fortune_bg"];
    _bgImageView.contentMode = UIViewContentModeScaleToFill;
    _bgImageView.userInteractionEnabled = YES;
    [self addSubview:_bgImageView];
    [_bgImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.center.mas_equalTo(self);
        make.size.mas_equalTo(CGSizeMake(KDialogAdaptedWidth(300), KDialogAdaptedWidth(341)));
    }];
    ...
    CGFloat itemW = KDialogAdaptedWidth(235.0f);
    CGFloat itemH = KDialogAdaptedWidth(68.0f);
    CGFloat marginX = KDialogAdaptedWidth(44.0f);

    // Item 1: 今日消耗
    _consumeBox = [[UIImageView alloc] init];
    _consumeBox.image = [UIImage imageNamed:@"theme_game_three_fortune_item_bg"];
    ...
    _produceBox.image = [UIImage imageNamed:@"theme_game_three_fortune_item_bg"];
    ...
    _yieldBox.image = [UIImage imageNamed:@"theme_game_three_fortune_item_bg"];
