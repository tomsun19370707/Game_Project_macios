...
- (void)setupUI {
    ...
    [retryButton setImage:[UIImage imageNamed:@"theme_game_one_result_retry_btn"] forState:UIControlStateNormal];
    ...
    [retryButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(KDialogAdaptedWidth(140.0f), KDialogAdaptedWidth(68.0f)));
    }];
}
