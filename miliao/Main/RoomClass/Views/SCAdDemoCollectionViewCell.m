...
//        _showImage.image = [UIImage imageNamed:h_model.imageName];
        [_showImage sd_setImageWithURL:[NSURL URLWithString:h_model.imageName] placeholderImage:[UIImage imageNamed:@"未加载图片"]];
        _nameLabel.text=[NSString stringWithFormat:@"%@",h_model.introduction];
    }else{
