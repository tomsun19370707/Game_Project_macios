...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo{
    if (error) {
        [SVProgressHUD showImage:KGetImage(@"") status:@"保存失败"];
        
    } else {
        [SVProgressHUD showImage:KGetImage(@"") status:@"保存成功"];
    }
...
//            if (wselfisHideNaviBar==YES) {
//                [wselfnavigationController setNavigationBarHidden:NO animated:YES];
//            }else{
//                [wselfnavigationController setNavigationBarHidden:YES animated:YES];
//            }
//            wselfisHideNaviBar = !wselfisHideNaviBar;
