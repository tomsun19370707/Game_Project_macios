...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _videoImageView.layer.cornerRadius=10;
        _videoImageView.layer.masksToBounds=YES;
        _videoImageView.hidden = YES;
        [self addSubview:_videoImageView];
        
        _deleteBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_deleteBtn setImage:[UIImage imageNamed:@"delImg"] forState:UIControlStateNormal];
...
-(void)setAssetHidden:(BOOL)assetHidden{
    _assetHidden=assetHidden;
    _videoImageView.hidden = assetHidden;
    _gifLable.hidden = assetHidden;
}
