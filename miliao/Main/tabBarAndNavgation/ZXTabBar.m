...
////        //设置背景图片
////        [btn setBackgroundImage:[UIImage imageNamed:@"tabCenterImg"]
////                       forState:UIControlStateNormal];
////        [btn setBackgroundImage:[UIImage imageNamed:@"tabCenterImg"]
////                       forState:UIControlStateHighlighted];
////            [btn setBackgroundImage:[UIImage imageNamed:@"logoD.gif"]
////                           forState:UIControlStateNormal];
////            [btn setBackgroundImage:[UIImage imageNamed:@"logoD.gif"]
////                           forState:UIControlStateHighlighted];
//        //设置button事件
...
//        YYAnimatedImageView* animatedView1 = [[YYAnimatedImageView alloc] init];
//        animatedView1.image=[YYImage imageNamed:@"logoDold.gif"];
//        animatedView1.frame=CGRectMake(-8,-8,KAdaptedWidth(58),KAdaptedWidth(58));
////        animatedView.center=plusBtn.center;
//        animatedView=animatedView1;
//        [plusBtn  addSubview:animatedView];
...
//    animatedView.image=[YYImage imageNamed:@"logoDold.gif"];
...
//    [self performSelector:@selector(delayDo) withObject:nil afterDelay:4];
//    //通知代理去处理
...
////    plusFrame.origin.y = - plusBtn.currentBackgroundImage.size.height / 3-KAdaptedHeight(5);
//    plusFrame.size = CGSizeMake(KAdaptedWidth(45), KAdaptedWidth(45));
//    plusFrame.origin.x = self.frame.size.width / 2 - KAdaptedWidth(45) / 2;
//    plusFrame.origin.y = - KAdaptedWidth(45) / 3-KAdaptedWidth(5);
...
//    [self addSubview:lable];
    ...
    CGFloat tabBarButtonWidth = self.frame.size.width / 4;
