...
- (CGFloat)panelWidth:(NSArray *)titleArr
{
    ...
    for (NSString *title in titleArr) {
        CGSize titleSize = [title ttt_sizeWithFont:TLFont(14.0) constrainedToSize:CGSizeMake(0, SCREEN_WIDTH) lineBreakMode:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading lineSpace:8];
